# Generated by Django 4.1.3 on 2022-12-18 08:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('product_list', 'صفحه لیست محصولات'), ('product_detail', 'صفحه جزئیات محصولات'), ('about_us', 'درباره ما')], max_length=200, verbose_name='جایگاه نمایش بنر')),
            ],
            options={
